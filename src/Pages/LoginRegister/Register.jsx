    ...
    <div>
      ...
      <div className="min-h-screen bg-[#49c3af]">
        <div className="md:p-12 lg:p-24 ">
          <div className="md:px-8 md:py-4 shadow-xl mx-4 p-8 flex flex-col lg:flex-row-reverse gap-2 md:gap-8 lg:gap-24 items-center">
            ...
            <div className="flex-1 w-full ">
              ...
              <form
                ...
                className="md:space-y-4 space-y-1 mx-2 md:mx-8"
              >
                <div>
