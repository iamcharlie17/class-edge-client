...
const ClassDetails = () => {
  ...
  console.log(data);
  const { image, name, email, title, description, enroll, price, category } =
    data;
  ...
  return (
    <div className="min-h-[calc(100vh-240px)]">
      <div className="flex flex-col lg:flex-row my-8 gap-8 lg:gap-12 mx-2 md:mx-24">
        ...
        <div className="lg:w-1/3 md:flex lg:flex-col gap-8 lg:items-start md:items-center p-4">
          <div className="">
            <div>
              <p>
          ...
          <div className="h-36 bg-black w-full">{/* payment method */}</div>
        </div>
      </div>
    </div>
  );
